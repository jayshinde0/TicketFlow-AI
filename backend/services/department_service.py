...
class DepartmentService:
    ...
    CROSS_DEPARTMENT_KEYWORDS: Dict[str, List[str]] = {
        "NETWORK": ["network", "connectivity", "vpn", "firewall", "dns", "ip address",
                     "bandwidth", "wifi", "ethernet", "proxy"],
        "SOFTWARE": ["software", "application", "crash", "bug", "error", "update",
                      "install", "login", "authentication", "api"],
        "DATABASE": ["database", "sql", "query", "backup", "restore", "migration",
                      "data loss", "table", "schema", "replication"],
        "SECURITY": ["phishing", "malware", "breach", "unauthorized", "hack",
                      "vulnerability", "exploit", "ransomware", "suspicious"],
        "BILLING": ["invoice", "payment", "charge", "refund", "subscription",
                     "billing", "credit", "discount", "pricing"],
        "HR_FACILITIES": ["hardware", "laptop", "monitor", "keyboard", "printer",
                           "desk", "office", "onboarding", "badge", "parking"],
    }
