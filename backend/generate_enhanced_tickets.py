...
ENHANCED_TICKETS = [
    ...
    # ═══════════════════════════════════════════════════════════════
    {
        ...
        "category": "Network",
        "priority": "High",
        "keywords": ["vpn", "connection", "timeout", "network", "connectivity", "cisco", "remote"]
    },
    {
        ...
        "category": "Network",
        "priority": "Medium",
        "keywords": ["wifi", "disconnecting", "network", "wireless", "connectivity", "internet"]
    },
    {
        ...
        "category": "Network",
        "priority": "High",
        "keywords": ["intranet", "portal", "network", "connection", "timeout", "firewall", "access"]
    },
    ...
    # ═══════════════════════════════════════════════════════════════
    {
        ...
        "category": "Auth",
        "priority": "High",
        "keywords": ["password", "forgot", "reset", "login", "authentication", "account", "access"]
    },
    {
        ...
        "category": "Auth",
        "priority": "Critical",
        "keywords": ["account", "locked", "login", "authentication", "password", "access", "unlock"]
    },
    {
        ...
        "category": "Auth",
        "priority": "High",
        "keywords": ["2fa", "two-factor", "authentication", "mfa", "login", "code", "authenticator"]
    },
    ...
    # ═══════════════════════════════════════════════════════════════
    {
        ...
        "category": "Software",
        "priority": "High",
        "keywords": ["excel", "crash", "software", "application", "office", "spreadsheet", "error"]
    },
    {
        ...
        "category": "Software",
        "priority": "Medium",
        "keywords": ["adobe", "acrobat", "software", "install", "application", "pdf", "license"]
    },
    {
        ...
        "category": "Software",
        "priority": "Critical",
        "keywords": ["zoom", "application", "software", "launch", "install", "meeting", "crash"]
    },
    ...
    # ═══════════════════════════════════════════════════════════════
    {
        ...
        "category": "Hardware",
        "priority": "High",
        "keywords": ["keyboard", "laptop", "hardware", "keys", "device", "repair", "replacement"]
    },
    {
        ...
        "category": "Hardware",
        "priority": "High",
        "keywords": ["printer", "hardware", "paper jam", "device", "printing", "error", "laserjet"]
    },
    {
        ...
        "category": "Hardware",
        "priority": "Medium",
        "keywords": ["monitor", "screen", "flickering", "hardware", "display", "device", "hdmi"]
    },
    ...
    # ═══════════════════════════════════════════════════════════════
    {
        ...
        "category": "Access",
        "priority": "Medium",
        "keywords": ["access", "permission", "shared folder", "network drive", "authorization", "grant"]
    },
    {
        ...
        "category": "Access",
        "priority": "High",
        "keywords": ["access", "salesforce", "crm", "permission", "denied", "authorization", "login"]
    },
    {
        ...
        "category": "Access",
        "priority": "Medium",
        "keywords": ["admin", "rights", "access", "permission", "install", "authorization", "privileges"]
    },
    ...
    # ═══════════════════════════════════════════════════════════════
    {
        ...
        "category": "Billing",
        "priority": "High",
        "keywords": ["billing", "charge", "duplicate", "refund", "payment", "invoice", "subscription"]
    },
    {
        ...
        "category": "Billing",
        "priority": "Medium",
        "keywords": ["invoice", "billing", "download", "payment", "expense", "transaction", "receipt"]
    },
    {
        ...
        "category": "Billing",
        "priority": "High",
        "keywords": ["billing", "payment", "subscription", "renewal", "declined", "charge", "card"]
    },
    ...
    # ═══════════════════════════════════════════════════════════════
    {
        ...
        "category": "Email",
        "priority": "High",
        "keywords": ["outlook", "email", "sync", "mail", "exchange", "inbox", "receiving"]
    },
    {
        ...
        "category": "Email",
        "priority": "Medium",
        "keywords": ["email", "attachment", "size limit", "outlook", "mail", "send", "file"]
    },
    {
    ...
    # ═══════════════════════════════════════════════════════════════
    {
        ...
        "category": "Security",
        "priority": "Critical",
        "keywords": ["security", "phishing", "suspicious", "email", "threat", "malware", "credentials"]
    },
    {
        ...
        "category": "Security",
        "priority": "Critical",
        "keywords": ["security", "malware", "virus", "antivirus", "threat", "trojan", "infected"]
    },
    {
        ...
        "category": "Security",
        "priority": "Critical",
        "keywords": ["security", "login", "failed attempts", "breach", "suspicious", "account", "threat"]
    },
    ...
    # ═══════════════════════════════════════════════════════════════
    {
        ...
        "priority": "High",
        "keywords": ["service request", "new employee", "setup", "laptop", "onboarding", "provisioning"]
    },
    {
        ...
        "category": "ServiceRequest",
        "priority": "Low",
        "keywords": ["service request", "monitor", "equipment", "request", "hardware", "setup"]
    },
    {
        ...
        "category": "ServiceRequest",
        "priority": "Medium",
        "keywords": ["service request", "conference room", "av equipment", "setup", "meeting", "projector"]
    },
    ...
    # ═══════════════════════════════════════════════════════════════
    {
        ...
        "category": "Database",
        "priority": "Critical",
        "keywords": ["database", "connection", "sql", "server", "timeout", "production", "access"]
    },
    {
        ...
        "category": "Database",
        "priority": "High",
        "keywords": ["database", "performance", "slow", "query", "sql", "optimization", "server"]
    },
    {
        ...
        "category": "Database",
        "priority": "Medium",
        "keywords": ["database", "access", "permission", "sql", "read-only", "analytics", "grant"]
    },
]
